...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    switch (message)
    {
        case WM_CREATE:
        {
            ...
            hButton =       CreateWindow(L"Button", L"X", StaticTextStyle, 100, 100, 100, 100, hWnd, (HMENU)IDB_ONE, hInst, NULL);
            std::wstring str_interval = std::to_wstring(config.interval);
            hInput1 =       CreateWindow(L"EDIT", str_interval.c_str(), StaticTextStyle, 220, 100, 100, 30, hWnd, (HMENU)IDB_ONE, hInst, NULL);
            std::wstring str_offset = std::to_wstring(config.offset);
            hInput2 =       CreateWindow(L"EDIT", str_offset.c_str(), StaticTextStyle, 340, 100, 100, 30, hWnd, (HMENU)IDB_ONE, hInst, NULL);

            std::wstring str = std::to_wstring(config.offset_2);
            hInput3 =       CreateWindow(L"EDIT", str.c_str(), StaticTextStyle, 460, 100, 100, 30, hWnd, (HMENU)IDB_ONE, hInst, NULL);
            /*std::wstring str2 = std::to_wstring(config.offset_2);
            hInput4 =       CreateWindow(L"EDIT", str2.c_str(), StaticTextStyle, 340, 200, 100, 30, hWnd, (HMENU)IDB_ONE, hInst, NULL);*/
        }
        case WM_COMMAND:
        {
...
void Init() 
{
    config.interval = GetPrivateProfileInt(L"General", L"interval", 0, iniFilePath.c_str());
    config.offset = GetPrivateProfileInt(L"General", L"offset", 0, iniFilePath.c_str());
    config.offset_2 = GetPrivateProfileInt(L"General", L"offset_2", 0, iniFilePath.c_str());
    Edit_SetText(hInput1, std::to_wstring(config.interval).c_str());
    Edit_SetText(hInput2, std::to_wstring(config.offset).c_str());
