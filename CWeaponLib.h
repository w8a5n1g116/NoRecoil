...
public: 
	...
	CWeapon M16A4			= CWeapon("M16A4", CWeapon::FUNCTION2);
	CWeapon QBZ				= CWeapon("QBZ", CWeapon::FUNCTION2);
	CWeapon SCAR_L			= CWeapon("SCAR-L", CWeapon::FUNCTION2);
	CWeapon AUG				= CWeapon("AUG", CWeapon::FUNCTION2);
	CWeapon G36C			= CWeapon("G36C", CWeapon::FUNCTION2);
	CWeapon K2				= CWeapon("K2", CWeapon::FUNCTION2);
	CWeapon M416			= CWeapon("M416", CWeapon::FUNCTION2);
	CWeapon FAMAS			= CWeapon("FAMAS", CWeapon::FUNCTION2);
	CWeapon DP_28			= CWeapon("DP_28", CWeapon::FUNCTION2);
	CWeapon M249			= CWeapon("M249", CWeapon::FUNCTION2);
	CWeapon Mk14			= CWeapon("Mk14", CWeapon::FUNCTION1);
	CWeapon SLR				= CWeapon("SLR", CWeapon::FUNCTION1);
	CWeapon SKS				= CWeapon("SKS", CWeapon::FUNCTION1);
	CWeapon Mk12			= CWeapon("Mk12", CWeapon::FUNCTION1);
	CWeapon Mini14			= CWeapon("Mini14", CWeapon::FUNCTION1);
	CWeapon QBU				= CWeapon("QBU", CWeapon::FUNCTION1);
	CWeapon VSS				= CWeapon("VSS", CWeapon::FUNCTION2);
	CWeapon Lynx_AMR		= CWeapon("Lynx AMR", CWeapon::FUNCTION1);
	CWeapon AWM				= CWeapon("AWM", CWeapon::FUNCTION1);
	CWeapon Kar98k			= CWeapon("Kar98k", CWeapon::FUNCTION1);
	CWeapon Mosin_Nagant	= CWeapon("Mosin Nagant", CWeapon::FUNCTION1);
	CWeapon M24				= CWeapon("M24", CWeapon::FUNCTION1);
	CWeapon Win94			= CWeapon("Win94", CWeapon::FUNCTION1);
	CWeapon UMP45			= CWeapon("UMP45", CWeapon::FUNCTION2);
	CWeapon Tommy_Gun		= CWeapon("Tommy Gun", CWeapon::FUNCTION2);
	CWeapon PP_19_Bizon		= CWeapon("PP 19 Bizon", CWeapon::FUNCTION2);
	CWeapon P90				= CWeapon("P90", CWeapon::FUNCTION2);
	CWeapon MP5K			= CWeapon("MP5K", CWeapon::FUNCTION2);
	CWeapon MP9				= CWeapon("MP9", CWeapon::FUNCTION2);
	...
	CWeapon MG3_660_RPM		= CWeapon("MG3 660 RPM", CWeapon::FUNCTION2);
